...
**어떤 MCP 서버와 Skill을 얼마나 썼는지** 주간·월간·전체 그래프로 보여준다.

순수 Swift (SwiftUI `MenuBarExtra` + Swift Charts). 외부 의존성 없음.

## 다운로드

[**AgentPulse.dmg 직접 다운로드 (v1.20.0)**](https://github.com/beyondworks/agentpulse/releases/download/v1.20.0/AgentPulse.dmg) — 열어서 AgentPulse를 Applications로 드래그.
